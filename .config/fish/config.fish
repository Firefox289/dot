...
alias v "vim"
alias f "flameshot gui"

starship init fish | source
thefuck --alias | source

export PATH="$PATH:/home/firefox289/.local/bin" && export SPOTIPY_CLIENT_ID=802c3ef2b9554299ba9df1464a7e1dec && export SPOTIPY_CLIENT_SECRET=73a50f429a6141c19b478794b4ac5d3f
